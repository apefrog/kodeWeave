...
document.querySelector("[data-action=save-gist]").onclick = function() {
  ...
  $.ajax({
    ...
    document.querySelector("[data-output=projectURL]").value = "http://purifier.scavengergoat.com/kodeWeave/editor/#" + embedProject;
    ...
    $("[data-target=editorURL]").on("change", function() {
      ...
      previewWeave.src = "http://purifier.scavengergoat.com/kodeWeave/embed/#" + embedProject + "?" + showEditors;
      document.querySelector("[data-output=embedProject]").value = "<iframe width=\"100%\" height=\"300\" src=\"http://purifier.scavengergoat.com/kodeWeave/embed/#" + embedProject + "?" + showEditors + "\" allowfullscreen=\"allowfullscreen\" frameborder=\"0\"></iframe>";
    });
    ...
    var previewWeave = document.getElementById("shareWeavePreview");
    previewWeave.src = "http://purifier.scavengergoat.com/kodeWeave/embed/#" + embedProject + "?" + showEditors;
    document.querySelector("[data-output=embedProject]").value = "<iframe width=\"100%\" height=\"300\" src=\"http://purifier.scavengergoat.com/embed/#" + embedProject + "?" + showEditors + "\" allowfullscreen=\"allowfullscreen\" frameborder=\"0\"></iframe>";
    document.querySelector("[data-output=embedProject]").onclick = function() {
      this.select(true);
    };

    $(".share-facebook").attr("href", "https://www.facebook.com/sharer/sharer.php?u=http%3A//purifier.scavengergoat.com/kodeWeave/editor/%23" + hash);
    $(".share-twitter").attr("href", "https://twitter.com/home?status=Checkout%20my%20"+ document.querySelector("[data-action=sitetitle]").value.split(" ").join("%20") +"%20%23weave%20on%20%23kodeWeave%20%23kodeWeaveShare%20-%20http%3A//purifier.scavengergoat.com/kodeWeave/e/%23" + hash);
    $(".share-gplus").attr("href", "https://plus.google.com/share?url=http%3A//purifier.scavengergoat.com/editor/%23" + hash);
    $(".share-linkedin-square").attr("href", "https://www.linkedin.com/shareArticle?mini=true&url=http%3A//purifier.scavengergoat.com/kodeWeave/editor/%23"+ hash +"&title=Checkout%20my%20%23weave%20on%20%23kodeWeave%3A%20&summary=&source=");
